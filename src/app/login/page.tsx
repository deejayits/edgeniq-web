    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 flex items-center justify-center px-6 py-12">
        <Card className="w-full max-w-md p-8 border-border/60 bg-card/50">
          ...
          {/* "Not you?" helper — Telegram stores the widget's cached
              identity in cookies on its own domain (oauth.telegram.org)
              which we cannot touch from edgeniq.com. Only real path is
              the user revoking the bot in their Telegram app. */}
